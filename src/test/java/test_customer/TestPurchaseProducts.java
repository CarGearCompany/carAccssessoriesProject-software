...
public class TestPurchaseProducts {
    ...
    public void theTransactionIsDoneSuccssfullyAndThePruchasedProductsListSizeWillBeAndQuantityOfThatProductWillBe(Integer int1, Integer int2) throws PurchaseNotConfirmedException, OutOfStockException, MessagingException, CategoryNotFoundException, ProductNotFoundException, NotEnoughItemsAvailableException {
        ...
        newQuantity = CustomerController.purchaseProduct(mock(EmailService.class),category,id, customer,confirm,quantity);
    ...
    public void theTransactionFailsAndProductNotFoundExceptionWillBeThrown() {
        customer = (Customer) CarGear.getCurrentUser();
        assertThrows(ProductNotFoundException.class, () -> CustomerController.purchaseProduct(mock(EmailService.class),category,id,customer,confirm,quantity));
    }
    ...
    public void theTransactionFailsAndCategoryNotFoundExceptionWillBeThrown() {
        customer = (Customer) CarGear.getCurrentUser();
        assertThrows(CategoryNotFoundException.class, () -> CustomerController.purchaseProduct(mock(EmailService.class),category,id, customer,confirm,quantity));
    }
    ...
    public void theTransactionIsNotCompletedAndPurchaseNotConfirmedExceptionWillBeThrown() {
        customer = (Customer) CarGear.getCurrentUser();
        assertThrows(PurchaseNotConfirmedException.class, () -> CustomerController.purchaseProduct(mock(EmailService.class),category,id,customer,confirm,quantity));
    }
    ...
    public void theTransactionIsNotDoneAndOutOfStockExceptionWillBeThrown() {
        customer = (Customer) CarGear.getCurrentUser();
        assertThrows(OutOfStockException.class, () -> CustomerController.purchaseProduct(mock(EmailService.class),category,id,customer,confirm,quantity));
    }
    ...
    public void theTransactionIsNotDoneAndNotEnoughItemsAvailableExceptionWillBeThrown() {
        customer = (Customer) CarGear.getCurrentUser();
        assertThrows(NotEnoughItemsAvailableException.class, () -> CustomerController.purchaseProduct(mock(EmailService.class),category,id,customer,confirm,quantity));
